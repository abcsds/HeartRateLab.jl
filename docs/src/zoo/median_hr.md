...
> **Median Heart Rate In Bpm From The Inter-Beat-Intervals (Ibis).**
...
Fitted normative prior: **Normal(μ = 79.79, σ = 15.48)**, KS p = 3.8e-108, n = 61715.

![Normative distribution of median_hr](figs/median_hr.png)
...
|---|---|
| median | 78.33 |
| IQR (25–75%) | 67.95 – 90.36 |
| 5–95% range | 57.31 – 106.8 |
| mean ± sd | 79.79 ± 15.48 |
| n windows | 61715 |
...
|---|---|
| cold median wall-time | 0.008987 ms |
| warm median wall-time | 0.003857 ms |
| allocations (cold) | 7.2 KiB |
