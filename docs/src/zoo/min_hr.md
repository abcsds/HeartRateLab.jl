...
| **Equation** | `60000 / min(IBI)` |
| **Resource intensity** | ◍◍◌◌◌  low — _Level 1–2 (base statistics over successive differences)._ (measured, see §Resources) |

## Definition

Minimum heart rate. Formally: `60000 / min(IBI)`.

## What does *normal* look like?

Fitted normative prior: **Normal(μ = 99.66, σ = 20.53)**  —  KS p = 2.1e-113, n = 56472.

![Normative distribution of min_hr](figs/min_hr.png)
...
|---|---|
| median | 97.24 |
| IQR (25–75%) | 85.35 – 111.3 |
| 5–95% range | 70.42 – 139.5 |
| mean ± sd | 99.66 ± 20.53 |
| n windows | 56472 |
...
|---|---|
| cold median wall-time | 0.006812 ms |
