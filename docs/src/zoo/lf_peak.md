...
Peak frequency in LF band. Formally: `argmax(PSD; 0.04; 0.15)`.

## What does *normal* look like?

Fitted normative prior: **Normal(μ = 0.06419, σ = 0.01828)**  —  KS p = 2.5e-306, n = 61715.

![Normative distribution of lf_peak](figs/lf_peak.png)
...
|---|---|
| median | 0.05926 |
| IQR (25–75%) | 0.05 – 0.07143 |
| 5–95% range | 0.04233 – 0.1 |
| mean ± sd | 0.06419 ± 0.01828 |
| n windows | 61715 |
...
- Centre frequency of the baroreflex-related LF oscillation (~0.1 Hz).
...
|---|---|
| cold median wall-time | 0.0554 ms |
| warm median wall-time | 0.003617 ms |
...
Peak frequency of the LF band, Task Force (1996).
