...
| **Equation** | `60000 / max(IBI)` |
| **Resource intensity** | ◍◍◌◌◌  low — _Level 1–2 (base statistics over successive differences)._ (measured, see §Resources) |

## Definition

Maximum heart rate. Formally: `60000 / max(IBI)`.

## What does *normal* look like?

Fitted normative prior: **Normal(μ = 65.78, σ = 13.52)**  —  KS p = 6.9e-45, n = 56472.

![Normative distribution of max_hr](figs/max_hr.png)
...
|---|---|
| median | 64.52 |
| IQR (25–75%) | 56.07 – 73.89 |
| 5–95% range | 45.98 – 89.29 |
| mean ± sd | 65.78 ± 13.52 |
| n windows | 56472 |
...
|---|---|
| cold median wall-time | 0.006602 ms |
| warm median wall-time | 0.003416 ms |
