...
| **Equation** | `integral(PSD; 0.003; 0.4) Hz` |
...
Total power (0.003-0.4 Hz). Formally: `integral(PSD; 0.003; 0.4) Hz`.

## What does *normal* look like?

Fitted normative prior: **Gamma(α = 0.9465, θ = 1650)**  —  KS p = 2e-125, n = 61715.

![Normative distribution of tp](figs/tp.png)
...
|---|---|
| median | 880.4 |
| IQR (25–75%) | 406.3 – 1790 |
| 5–95% range | 134.4 – 5160 |
| mean ± sd | 1562 ± 2330 |
| n windows | 61715 |
...
- Overall spectral variance across HRV bands.
...
|---|---|
| cold median wall-time | 0.05475 ms |
| warm median wall-time | 0.004428 ms |
| allocations (cold) | 30.1 KiB |
...
Total power, Akselrod et al. (1981) / Task Force (1996); Welch (1967) periodogram averaging for the resampled backend.

**Seminal reference(s):** [akselrod1981](@cite); [taskforce1996](@cite); [welch1967](@cite).
