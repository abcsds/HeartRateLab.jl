...
Maximum inter-beat interval. Formally: `max(IBI)`.

## What does *normal* look like?

Fitted normative prior: **Normal(μ = 953.1, σ = 197.4)**  —  KS p = 2.8e-11, n = 61715.

![Normative distribution of max](figs/max.png)
...
|---|---|
| cold median wall-time | 0.003587 ms |
| warm median wall-time | 0.003497 ms |
