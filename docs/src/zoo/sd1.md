...
**SD1 and RMSSD are the same statistic** (SD1 = RMSSD/sqrt(2)), yet much of the clinical/sports literature reports both as independently "significant" findings, which double-counts the same signal ([ciccone2017](@cite)).
