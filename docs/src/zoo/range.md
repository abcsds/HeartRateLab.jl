...
| **Equation** | `max(IBI) - min(IBI)` |
| **Resource intensity** | ◍◍◌◌◌  low, _Level 1–2 (base statistics over successive differences)._ (measured, see §Resources) |

## Definition

Range of inter-beat intervals. Formally: `max(IBI) - min(IBI)`.

## What does *normal* look like?

Fitted normative prior: **Gamma(α = 3.49, θ = 94.08)**, KS p = 4.4e-14, n = 61715.

![Normative distribution of range](figs/range.png)
...
|---|---|
| cold median wall-time | 0.01068 ms |
| warm median wall-time | 0.003687 ms |
