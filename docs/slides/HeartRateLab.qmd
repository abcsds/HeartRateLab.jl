...
# infile = "/home/beto/.julia/dev/HeartRateLab/test/testdata/e1304.txt"
infile = "/home/beto/.julia/dev/HeartRateLab/docs/slides/example.xdf"
...
lines!(ax2, t, n .- mean(n), color=:blue, linewidth=3, label="Detrended RR-interval signal")
...
#| output: slide
#| label: rmssd
println("SDNN: ", round(StatsBase.std(x[]), digits=2))
println("RMSSD: ", round(StatsBase.std(n), digits=2))
```
...
#| label: windowed-long
ds_windowed = HeartRateLab.Features.windowed_feature_set(
    data, features=["vlf", "rmssd"], window_size=120, stride=10
)

ax = Axis(f[3, 1], 
    title="RMSSD through Time WS=120, S=10",
    xlabel="Time (s)",
    ylabel="RMSSD (ms²)")
x = ds_windowed.rmssd
t = 1:length(x)
